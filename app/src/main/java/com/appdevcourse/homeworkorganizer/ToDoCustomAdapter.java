...
class ToDoCustomAdapter extends RecyclerView.Adapter<ToDoCustomAdapter.CustomViewHolder> {
    private static ArrayList<Assignment> mAssignments;
    private static AdapterOnClickHandler mAdapterOnClickHandler;
    public Check check;
    public Delete delete;

    public ToDoCustomAdapter(ArrayList<Assignment> mAssignments, AdapterOnClickHandler ach, Check check, Delete delete) {
